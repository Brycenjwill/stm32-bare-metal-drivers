...
typedef struct
{
	...
	GPIO_PinConfig GPIO_PinConfig; // GPIO Pin config settings
 ...
 * For more info see function definitsions
 */
...
void GPIO_PeriClockControl(GPIO_RegDef_t *pGIOx, uint8_t EnorDi);
